...
class BattleEndMessage(PiranhaMessage):
    ...
    def encode(self, fields, player):
        ...
        self.writeVInt(fields['Result']) # Battle End Game Mode (gametype)
        ...
        self.writeBoolean(False)
        self.writeBoolean(False)
        self.writeBoolean(True) # Batle Type
        self.writeBoolean(False)
        self.writeBoolean(False)
        self.writeBoolean(False)
        self.writeVInt(-1)
        ...
        for heroEntry in fields["Heroes"]:
            ...
            self.writeInt16(0) # Wins
            self.writeInt16(0) # Deathes
            self.writeInt(0) # Battles
            self.writeInt(25659)
